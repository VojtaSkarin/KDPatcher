...
const char * INITIAL_RELEASE_FILENAME = "InitialRelease.ada";
...
void download_init( const std::string & initial_release_url_url, const std::string & first_version_url, bool revert_to_init );
